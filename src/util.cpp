...
int nAnonymizeAdvantageAmount = 1000;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Advantage.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Advantaged.pid"));
