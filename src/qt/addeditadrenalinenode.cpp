    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    //Labels
    ui->aliasLineEdit->setPlaceholderText("Enter your Masternode's Name");
    ui->addressLineEdit->setPlaceholderText("Enter Your IP & Port");
    ui->privkeyLineEdit->setPlaceholderText("Enter your Masternode private key(masternode genkey)");
    ui->txhashLineEdit->setPlaceholderText("Enter your 1,000,000 A TXID");
