...
#win32:OPENSSL_INCLUDE_PATH=C:/deps/openssl-1.0.2n/include
#win32:OPENSSL_LIB_PATH=C:/deps/openssl-1.0.2n
...
isEmpty(BOOST_LIB_SUFFIX) {
    ...
    win32:BOOST_LIB_SUFFIX = -mgw53-mt-1_55
}
...
isEmpty(BOOST_LIB_PATH) {
    ...
    win32:BOOST_LIB_PATH = c:/local/boost_1_55/lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /opt/local/include
    win32:BOOST_INCLUDE_PATH = c:/local/boost_1_55
}
...
isEmpty(BDB_LIB_PATH) {
    ...
    win32:BDB_LIB_PATH = c:/local/db48/lib
}

isEmpty(BDB_INCLUDE_PATH) {
    macx:BDB_INCLUDE_PATH = /opt/local/include/db48
    win32:BDB_INCLUDE_PATH = c:/local/db48/include
}
...
isEmpty(OPENSSL_INCLUDE_PATH) {
    win32:OPENSSL_INCLUDE_PATH = c:/local/openssl-1.0.2n/include
}
isEmpty(OPENSSL_LIB_PATH) {
    win32:OPENSSL_LIB_PATH = c:/local/openssl-1.0.2n/lib
}

isEmpty(MINIUPNPC_INCLUDE_PATH) {
    win32:MINIUPNPC_INCLUDE_PATH = c:/local/miniupnpc1p6
}
isEmpty(MINIUPNPC_LIB_PATH) {
    win32:MINIUPNPC_LIB_PATH = c:/local/miniupnpc1p6/lib
}


isEmpty(SECP256K1_LIB_PATH) {
    windows:SECP256K1_LIB_PATH=C:/local/secp256k1/lib32
}
isEmpty(SECP256K1_INCLUDE_PATH) {
    windows:SECP256K1_INCLUDE_PATH=C:/local/secp256k1/include
}
...
macx:ICON = src/qt/res/icons/printex.icns
macx:TARGET = "printex-Qt"
